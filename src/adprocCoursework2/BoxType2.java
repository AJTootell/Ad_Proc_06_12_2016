 ...
 * @author Dylan
 */
public class BoxType2 extends BasicBox {
    public BoxType2(int depth, int length, int height, int cardGrade,boolean sealableTop, int quantity) {
     ...
     public double calculateCosts() {
        ...
        cost = cost * (1.13 + sealableTopPercentage);
