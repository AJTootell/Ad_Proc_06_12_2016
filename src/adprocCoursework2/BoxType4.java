 ...
 * @author Dylan
 */
public class BoxType4 extends BasicBox {
    public BoxType4(int depth, int length, int height,int cardGrade, boolean sealableTop, int quantity) {
     ...
     public double calculateCosts() {
        ...
        cost = cost * (1 + 0.16 + 0.14 + sealableTopPercentage);
