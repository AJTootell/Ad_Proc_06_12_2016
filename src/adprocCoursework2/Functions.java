...
public class Functions {
    static ArrayList<BasicBox> OrderBox = new ArrayList();
    ...
    public static void validateAndAdd(String depth, String length, String height,int cardGrade, int colour, boolean reinforcedBottom, boolean reinforcedCorners, boolean sealableTop, int quantity) {
        ...
        addBoxToArray(giveDepth, giveLength, giveHeight, cardGrade, colour, reinforcedBottom, reinforcedCorners, sealableTop, quantity);
        System.out.println(OrderBox.get(OrderBox.size() - 1).getClass());
    }

    //create and add new boxes to the array
    public static void addBoxToArray(int depth, int length, int height,int cardGrade, int colour, boolean reinforcedBottom, boolean reinforcedCorners,boolean sealableTop, int quantity) {
